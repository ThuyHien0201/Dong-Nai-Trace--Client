...
const PIE_DATA = [
  { label: 'Đã duyệt', value: 194, color: '#1f7a45', pct: 78.5 },
  { label: 'Chờ duyệt', value: 31, color: '#E8650A', pct: 12.6 },
  { label: 'Đã khóa', value: 22, color: '#c0392b', pct: 8.9 },
];

const ACTIVITIES = [
  { id: 1, title: 'Doanh nghiệp "Vĩnh Hảo" đã duyệt', time: '2 phút trước', type: 'approve', icon: 'check-circle', color: '#1f7a45' },
  { id: 2, title: 'Sản phẩm mới "Bưởi Tân Triều" đã duyệt', time: '15 phút trước', type: 'approve', icon:'check-circle', color: '#1f7a45'},
  { id: 3, title: 'QR Code "BVHO-2024" đã duyệt', time: '45 phút trước', type: 'approve', icon: 'check-circle', color: '#1f7a45' },
  { id: 4, title: 'Doanh nghiệp "An Phú Foods" đã duyệt', time: '1 giờ trước', type: 'approve', icon: 'check-circle', color: '#1f7a45'},
